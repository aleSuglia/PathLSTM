...
public class SequentialParity extends TrialStreamAdapter {
    public static void main(final String[] args) {
        ...
        /**
         ...
         @Override public void postEpoch(final int ep, final TestStat stat)
         {
    ...
    /**
     * @param trialsPerEpoch The number of trials between evaluations.
     * @param trialLength    The number of steps (input/output pairs) in a trial.
     */
